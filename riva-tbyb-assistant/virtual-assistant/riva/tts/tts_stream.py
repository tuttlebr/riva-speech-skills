...
class TTSPipe(object):
    ...
    def __init__(self):
        ...
        self.sample_rate = (
            tts_config["SAMPLE_RATE"] if "SAMPLE_RATE" in tts_config else SAMPLE_RATE
        )
        self.language_code = (
            tts_config["LANGUAGE_CODE"]
            if "LANGUAGE_CODE" in tts_config
            else LANGUAGE_CODE
        )
        self.voice_name = (
            tts_config["VOICE_NAME"] if "VOICE_NAME" in tts_config else VOICE_NAME
        )
